            ...
            <div class="aboutUsPageRow">
                ...
                <div class="rightSide">
                    <div class="textSide">
                        ...
                        <div class="p">
                            Наша компания - это многоканальный контактный центр, который занимается обслуживанием
                            туристических объектов в Анталии, информационной консультацией туристов 24/7, приемом и
                            обработкой заявок, подтверждением брони и консультационным сопровождением до окончания тура.
                        </div>
                        <div class="p">
                            Площадка принципа « Заказчик - Исполнитель» особенно актуальна для туристического региона
            ...
            <div class="aboutUsPageRow swiperRow">
                <div class="leftSide">
                    <div class="textSide">
                        ...
                        <div class="p">
                            Мы предлогаем не только экскурсии по достопримечательностям Турции, но также мыготовы
