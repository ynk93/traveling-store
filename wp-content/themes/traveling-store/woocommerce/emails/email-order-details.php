    ...
    <td>
        ...
        <table class="mainDataTable">
            ...
            <tr class="mainRow">
                ...
                <td>
                    <span><?php echo wp_kses_post( $item_totals['cart_subtotal']['label'] ); ?></span>
                </td>
                <td>
                    <span><?php echo wp_kses_post( $item_totals['cart_subtotal']['value'] ); ?></span>
                </td>

                <td>
                    <span><?php echo wp_kses_post( $item_totals['payment_method']['label'] ); ?></span>
                </td>
                <td>
                    <span><?php echo wp_kses_post( $item_totals['payment_method']['value'] ); ?></span>
                </td>
            ...
            <tr>
                ...
                <td>
                    <span><?php echo wp_kses_post( $item_totals['order_total']['label'] ); ?></span>
                </td>
                <td>
